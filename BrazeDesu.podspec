...
Pod::Spec.new do |s|
  s.name             = 'BrazeDesu'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BrazeDesu.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/48179357/BrazeDesu'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '48179357' => 'saivenkatdesu@gmail.com' }
  s.source           = { :git => 'https://github.com/48179357/BrazeDesu.git', :tag => s.version.to_s }
